...
for directors in nominated.values():
    ...
    for director in directors:
        count_nominations[director] = count_nominations.get(director,0) + 1
print(count_nominations)
print('#' * 99)
...
for director, count in win_count_dict.items():
    print("director: {}- {} oscar wins".format(director,count))
...
winners_list = []
count_list = []
for director in winners.values():
...
# more succint solution using list comprehensions
...
most_wins = []
director_count_dict = {}
for director_list in winners.values():
    for winner in director_list:
        director_count_dict[winner] = director_count_dict.get(winner,0) + 1
# print(director_count_dict)

most_wins = max(director_count_dict.values())
most_wins = [key for key, value in director_count_dict.items() if value==most_wins]
print("director with most wins is {}".format(most_wins))