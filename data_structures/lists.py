print("Data structures are containers of data that store and organize different kinds of data in different ways")
...
print('#' * 79)
print("The list is one of the most common data structure in Python.\n It is a data structure for a mutable ordered sequence of elements")
...
print('#' * 79)
print("Note that indexing starts from zero(counting from front the first index is zero and counting from the back, index starts from -1) and the slicing uses a lower bound and an upper bound where the lower bound is inclusive and the upper bound is exclusive")
print('#' * 79)
