...
print('#' * 79)
print("While a list can have a mix and match of data types, the max and min methods are undefined for lists that consist of incomparable data types e.g list and strings and will produce a TypeError")
print('#' * 79)
