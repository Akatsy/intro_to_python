...
print("Sets are mutable meaning you can modify the contents. They are unordered, meaning you cannot index or slice to access elements")
print('#' * 79)
...
print('#' * 79)
print("Sets are simple data structures and they have one main use - collecting unique elements".upper())
print("sets also make it easier to perform mathematical set operations such as union, intersection and difference")