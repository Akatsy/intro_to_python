...
print("raining_outside = True and checking" , "type(raining_outside) gives", type(raining_outside))
...
print('#' * 79)
print("These are the comparison operators (also called relational operators) in Python:")
...
print('#' * 79)
print("The logical operators in Python are:")
print("1. 'and' operator that evaluates if both sides of the equation are true e.g 20>5 and 30==30 evaluates to", 20>5 and 30==30)
print("2. 'or' operator that evaluates if at least one side of the equation is true e.g 20<5 or 30==30 evaluates to", 20<5 or 30==30)
