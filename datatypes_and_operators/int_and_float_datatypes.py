...
print("Note the float() function adds a .0 (a decimal point zero) to the end of the integer to make it a float")
print('#' * 79)
...
print("type(25 // 5)", type(25 // 5))
print('#' * 99)
print("When programming, you will have to use your own judgement to pick your numerical data types in a way that works for your program but remember use 'int' for values that are whole numbers without decimal places (fractional values) and 'float' for values with fractional values i.e if what you will be working with is not neccessarily a whole number")
print('#' * 99)
