...
print('#' * 79)
print("You can convert one numerical data type to the other i.e from float to int and int to float using the 'int()' and 'float()' methods like below:")
print('#' * 79)
...
print("type(25 % 5.0)", type(25 % 5.0))
print("type(25 // 5.0)", type(25 // 5.0))
print("int division int will also produce float as the answer")
