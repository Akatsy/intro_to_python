# how to store numerical data using the int and float data types
...
print('#' * 79)
print("You can convert one numerical data type to the other i.e from float to int and int to float using the 'int()' and 'float()' built-in methods like below:")
print('#' * 79)
...
print("type(25 % 5.0)", type(25 % 5.0))
print("type(25 // 5.0)", type(25 // 5.0))
print("int division int will also produce float as the answer - as '/' is arithmetic the operator for float division ")
print("type(45/9)", type(45/9))
print('#' * 79)
print("When programming, you will have to use your judgement to pick your numerical data types in a way that works for your program but remember use 'int' for values that are whole numbers without decimal places and 'float' for values with fractional values i.e if what you will be working with is not neccessarily a whole number")