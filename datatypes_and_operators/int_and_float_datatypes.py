...
print('#' * 99)
print("Floats can represent an enormous range of numbers hence floating point numbers are actually approximations of the numbers they are supposed to represent")
