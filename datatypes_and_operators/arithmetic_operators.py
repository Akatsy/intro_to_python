...
print("25 * 38 = ", 25*38)
print('#' * 79)
print("The '**'(double asterisk) the python arithmetic operator for exponentiation as shown below:")
print("15 ** 8 = ", 15**8)
print('#' * 79)
print("The '/'(forward slash) symbol is the python arithmetic operator for division as shown below:")
