...
print("25 * 38 = ", 25*38)
print('#' * 79)
print("The '**'(double asterisk) is the python arithmetic operator for exponentiation(raising one number to the power of another) as shown below:")
print("15 ** 8 = ", 15**8)
print('#' * 79)
...
print("-53 // 7 = ", -53//7)
print('#' * 79)
print("The '%'(percentage) symbol is the python arithmetic operator for modulo operation(finds the remainder after division of one number by another (called the modulus of the operation)) as shown below:")
print("38 % 4 = ", 38%4)
print('#' * 79)
print("The mathematical order of operation holds in Python i.e given a mixture of arithmetic operations in the same equation, then they will be executed following the following order from first to last: PEMDAS(Parantheses, Exponentiation, Multiplication, Division, Addition, Subtraction)")
...
print("For example altering the order of the equation above will result in a different answer as follows: 3 + (5 - 5) * 6 ** 4 / 2 // 2 % 5 will evaluate to", 3 + (5 - 5) * 6 ** 4 / 2 // 2 % 5)
