...
print("The '+' symbol is the python arithmetic operator for addition as shown\
 below:")
print("3 + 5 = ", 3+5)
print('#' * 79)

print("The '-' symbol is the python arithmetic operator for subtraction as shown\
 below:")
print("100 - 56 = ", 100-56)
print('#' * 79)

print("The '*' (asterisk) symbol is the python arithmetic operator for\
 multiplication as shown below:")
print("25 * 38 = ", 25*38)
print('#' * 79)

print("The '**' (double asterisk) is the python arithmetic operator for\
 exponentiation (i.e raising one number to the power of another) as shown below:")
print("15 ** 8 = ", 15**8)
print('#' * 79)

print("The '/' (forward slash) symbol is the python arithmetic operator for\
 division (float division) as shown below:")
print("Note that the result of the '/' operator is always a float even when the\
 result is a whole number")
print("65 / 5 = ", 65/5)
print('#' * 79)

print("The '//' (double forward slash) is the python arithmetic operator for\
 integer division (floored quotient) as shown below:")
print("Integer division means the answer is rounded down to the nearest integer\
 and this applies to even negative real numbers")
print("43 // 5 = ", 43//5)
print("-53 // 7 = ", -53//7)
print('#' * 79)
...
print("To change the order of operation i.e to have an operation executed first,\
 ...
 it goes to the next parantheses till execution is done")
