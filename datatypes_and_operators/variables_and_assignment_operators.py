...
print('#' * 79)
print("Whatever term is on the left (variable_name) becomes a name for whatever value is on the right. The '=' sign is what is called 'assignment operator' and all it does is it assigns value on the right to the variable_name on the left.")
print("N.B: THE '=' SIGN DOES NOT SIGNIFY EQUALITY!! IT DOES NOT MEAN THAT THE NAME ON THE LEFT IS EQUAL TO THE VALUE ON THE RIGHT AND CONVERSELY THAT THE VALUE ON THE RIGHT IS EQUAL TO THE NAME ON THE LEFT AS THE CONVENTIONAL '=' SIGN MEANS IN MATH.")
print('#' * 79)
...
print("\t1. can only contain ordinary letters (so no usage of special characters like $), numbers and underscores and must begin with a letter or underscore - so cannot begin with a number")
print("\t2. must be one word - so no spaces allowed. Use underscores if you want to seperate words.")
print("\t3. must not be Python reserved keywords or built-in identifiers")
print("\t4. construct your variable names using snake_case i.e all lowercase and use underscores to join words - not a rule, rather a convention used by many Pythonistas. Not following this will not result in an error unlike the other three above.")
print('#' * 79)
print("You can declare multiple variables at once using a single expression like this:")
print("x,y,z = 4, 5.6, 8")
...
print('x /= 5 gives', x)
print('#' * 79)
print('Below are python keywords that cannot be used as variable names (read as \'should not\'- because really you can use them but they will lead to unwanted errors eventually when you try using them for their reserved purposes in Python):')
print("")
import keyword
