...
print('#' * 79)
print("Strings are created by wrapping any character in quotes. Both single(') and double(\") quotes can be used")
...
print("len() returns the number of characters in a string e.g len('Hello world') returns:", len('Hello world'))
print('#' * 79)
