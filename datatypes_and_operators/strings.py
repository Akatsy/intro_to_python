...
print("The sep(separator) argument is used to specify how the string should be split. By default the whitespace is the sep argument.")
...
print("Indexing(using [] and an integer denoting the index you want) gets you one character at a time. Slicing(using subscripts separated by :(colon)) gets you a subset of characters from the string at a go")
print("You can get the first character in a string like this print('hello world[0]') >>>", 'hello world'[0])
print("You can get the first three characters in a string like this print('hello world[:3]') >>>", 'hello world'[0:3])
