...
print("This can be especially useful in higher order functions (i.e functions that take other functions as arguments)")
print('#' * 99)
...
print("Given this structure, lambda expressions are not ideal for complex functions but can be very useful for simple functionss")
print('#' * 99)
