...
print("Suppose we want to create a list of all squares of numbers from 0 to 20,\
 we could use list comprehensions as follows:\nsquares = [num**2 for num in range(21)]\nprint(squares)")
print(squares)
print('#' * 99)

print("We can add conditional statements to the list comprehensions as follows:")
print("Suppose we want to print out just the squares of even numbers. We could add\
 a conditional as follows:\neven_squares = [num**2 for num in range(21) if x % 2 ==0]")
even_squares = [num**2 for num in range(21) if num % 2 == 0]
print(even_squares)
print('#' * 99)

print("If you want to add an else statement, you have to move the conditional to\
 the beginning of the list comprehension just after the expression to be evaluated for each element")
